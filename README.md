...
- Este sistema es un prototipo funcional que puede escalar a un sistema real.
- Todos los scripts son idempotentes, lo que permite ejecutarlos varias veces sin errores.
- Yo recomiendo MySQL 8.x o superior para triggers, eventos y roles.
- Los datos de prueba incluidos permiten probar funciones, triggers y reportes.
